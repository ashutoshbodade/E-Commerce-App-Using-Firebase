...
import com.octalgroup.mobilegurushop.Adapter.SelectAddressAdapter
...
class SelectAddressActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        this.setTitle("Select Address for Delivery")
        ...
        db.collection("users").document(userid()).collection("address")
            .addSnapshotListener { value, e ->
                ...
                val adp = SelectAddressAdapter(this, productsList)
